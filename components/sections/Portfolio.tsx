      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-earth-600 max-w-2xl mx-auto">
            A showcase of my recent projects in software development and data
            analysis
          </p>
        </motion.div>
          ...
          {PROJECTS.map((project) => (
            <motion.div key={project.id} variants={item}>
              <Card hover variant="elevated" className="h-full flex flex-col">
                ...
                <div className="w-full h-48 bg-gradient-to-br from-sage-200 to-gold-200 rounded-xl mb-4 flex items-center justify-center text-earth-400">
